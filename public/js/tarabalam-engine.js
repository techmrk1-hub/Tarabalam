    ...
    const languagesDataset = {
        te: {
            appTitle: "తారాబలం గణన పట్టిక మరియు సమగ్ర సూ�ారాబలం గణన పట్టిక మరియు సమగ్ర సూచిక",
            ...
            outSummary: "సారాం�్ణయం / ఫలితం (Verdict):",
            ...
            stars: ["�ుకూలం", atyanta: "అత్యంత అనుకూలం" },
            stars: ["అశ్విని", "భరణి", "కృత్తిక", "రోహిణి", "మృగశిర", "ఆరు�", "రోహిణి", "మృగశిర", "ఆరుద్ర", "పునర్వసు", "పుష్యమి", "ఆశ్లేష", "మఖ", "పుబ్బ", "ఉత్తర", "హస్త", "చి��్త", "స్వాతి", "విశాఖ", "అనూరాధ", "జ్యే��్ఠ", "మూల", "పూర్వాషాఢ", "ఉత్తరా�మఖ", "పుబ్బ", "ఉత్తర", "హస్త", "చిత్త", "స్వాతి", "విశాఖ", "అనూరాధ", "జ్యేష్ఠ", "మూల", "పూర్వాషాఢ", "ఉత్తరాషాఢ", "శ్రవణం", "ధనిష్ఠ", "శతభిషం", "పూర్వాభాద్ర", "ఉత్తరాభాద్ర", "రేవతి"],
            rules: {
                1: { title: "జన్మ తారా", summary: "మనస్సు/శరీర శ్రమ", guidance: "సాధారణంగా శుభకార్యాలకు నివారించు�ారణంగా శుభకార్యాలకు నివారించుట మంచిది" },
                ...
                7: { title: "నైధన తారా", summary: "హాని/సంకట సూచన", guidance: "అత్యంత �హాని/సంకట సూచన", guidance: "అత్యంత జాగ్రత్త; సాధ్యమైతే ముఖ్య కార్యాలు నివారించాలి" },
                8: { title: "మి��్ర తారా", summary: "సహకారం/స్నేహం", guidance: "సంభా�ు నివారించాలి" },
        ...
        kn: {
            ...
            milestoneTag: "✨ ತಾರಾಬಲಂ ಎಂಬುದು ವೈದಿಕ ಜ್ಯೋತಿಷ್ಯದಲ್ಲಿ \"ನಕ್�ಾರಾಬಲಂ ಎಂಬುದು ವೈದಿಕ ಜ್ಯೋತಿಷ್ಯದಲ್ಲಿ \"ನಕ್ಷತ್ರ ಬಲ\"ವನ್ನು ಸೂಚಿಸುತ್ತದೆ, ಇದು ವ್ಯಕ್ತಿಯ ಜನ್ಮ ನಕ್ಷತ್ರ ಮತ್ತು ಪ್ರಸ್ತುತ ದಿನದ ನಕ್ಷತ್ರದ ನಡುವಿನ ಹೊಂದಾಣಿಕೆಯನ್ನು ಲೆಕ್ಕ��ಾಕಿ ಹೊಸ ಕೆಲಸಗಳ ಆರಂಭಕ್ಕೆ ಶುಭ ಮುಹೂರ್ತವನ್ನು �ು ಪ್ರಸ್ತುತ ದಿನದ ನಕ್ಷತ್ರದ ನಡುವಿನ ಹೊಂದಾಣಿಕೆಯನ್ನು ಲೆಕ್ಕಹಾಕಿ ಹೊಸ ಕೆಲಸಗಳ ಆರಂಭಕ್ಕೆ ಶುಭ ಮುಹೂರ್ತವನ್ನು ಆಯ್ಕೆ ಮಾಡಲು ಸಹಾಯ ಮಾಡುತ್ತದೆ ✨",
            ...
            footerLabel: "ಹೆಚ್ಚಿನ ವಿವರಗಳಿಗಾಗಿ ನಮ್ಮ ಜ್ಯೋತಿಷ್ಯ ��ಜ್ಞರನ್ನು ಇಮೇಲ್ ಮಾಡಿ: ",
            tabEngine: "ತಾರಾಬಲಂ ಇಂ�            footerLabel: "ಹೆಚ್ಚಿನ ವಿವರಗಳಿಗಾಗಿ ನಮ್ಮ ಜ್ಯೋತಿಷ್ಯ ತಜ್ಞರನ್ನು ಇಮೇಲ್ ಮಾಡಿ: ",
            ...
            stars: ["�ಭ", atyanta: "ಅತ್ಯಂತ ಆನುಕೂಲಕರ" },
            stars: ["ಅಶ್ವಿನಿ", "ಭರಣಿ", "ಕೃತಿಕಾ", "ರೋಹಿಣಿ", "ಮೃಗಶಿರ", "ಆರಿದ್ರಾ", "ಪುನರ್ವಸು", "ಪುಷ್ಯ", "ಆ��್ಲೇಷಾ", "ಮಖಾ", "ಪೂರ್ವಾಫಾಲ್ಗುಣಿ", "ಉತ್ತರಾಫಾ��್ಗುಣಿ", "ಹಸ್ತಾ", "ಚಿತ್ರಾ", "ಸ್ವಾತಿ", "ವಿಶಾಖಾ", "�ೃಗಶಿರ", "ಆರಿದ್ರಾ", "ಪುನರ್ವಸು", "ಪುಷ್ಯ", "ಆಶ್ಲೇಷಾ", "ಮಖಾ", "ಪೂರ್ವಾಫಾಲ್ಗುಣಿ", "ಉತ್ತರಾಫಾಲ್ಗುಣಿ", "ಹಸ್ತಾ", "ಚಿತ್ರಾ", "ಸ್ವಾತಿ", "ವಿಶಾಖಾ", "ಅನುರಾಧಾ", "ಜ್ಯೇಷ್ಠಾ", "ಮೂಲಾ", "ಪೂರ್ವಾಷಾಢ", "ಉತ್ತರಾಷಾಢ", "ಶ್ರವಣ", "ಧನಿಷ್ಠಾ", "ಶತಭಿಷ", "ಪೂರ್ವಾಭಾದ್ರಪದ", "ಉತ್ತರಾಭಾದ್ರಪದ", "ರೇವತಿ"],
            rules: {
                ...
                3: { title: "ವಿಪತ್ ತಾರಾ", summary: "ಅಡೆತಡೆಗಳು ಮತ್ತು ನಷ್ಟದ ಭೀತಿ", guidance: "�ಿಪತ್ ತಾರಾ", summary: "ಅಡೆತಡೆಗಳು ಮತ್ತು ನಷ್ಟದ ಭೀತಿ", guidance: "ಪ್ರಯಾಣ ಮತ್ತು ಪ್ರಮುಖ ಕಾರ್ಯಗಳನ್ನು ಮಾಡುವಾಗ ಜಾಗರೂಕರಾಗಿರಿ" },
