    ...
    const languagesDataset = {
        te: {
            appTitle: "తారాబలం గణన పట్టిక మరి� Localized Matrix Schema Registry
    const languagesDataset = {
        te: {
            appTitle: "తారాబలం గణన పట్టిక మరియు సమగ్ర సూచిక",
            milestoneTag: "✨ తారాబలం అనేది వైదిక జ్యోతిషశాస్త్రంలో �తిషశాస్త్రంలో ఒక ముఖ్యమైన భాగము, ఇది ఒక వ్యక్తి యొక్క జన్మ నక్షత్రం మరియు ప్రస్తుత రోజు నక్షత్రం మధ్య అనుకూలతను లెక్��ించి నూతన పనులకు శు�్రం మధ్య అనుకూలతను లెక్కించి నూతన పనులకు శుభ ముహూర్తాన్ని నిర్ణయించడానికి ఉపయోగపడుతుంది ✨",
            ...
            stars: ["అశ్విని", "భరణి", "క��త్తిక", "రోహిణి", "మృగ�: ["అశ్విని", "భరణి", "కృత్తిక", "రోహిణి", "మృగశిర", "ఆరుద్ర", "పునర్వసు", "పుష్యమి", "ఆశ్లే��", "మఖ", "పుబ్బ", "ఉత్తర", "�సు", "పుష్యమి", "ఆశ్లేష", "మఖ", "పుబ్బ", "ఉత్తర", "హస్త", "చిత్త", "స్వాతి", "విశాఖ", "అనూరాధ", "జ్యేష్ఠ", "మూల", "పూర్వాషాఢ", "ఉత్తరాషాఢ", "శ్రవణం", "ధనిష్ఠ", "శతభిషం", "పూ�ణం", "ధనిష్ఠ", "శతభిషం", "పూర్వాభాద్ర", "ఉత్తరాభాద్ర", "రేవతి"],
            rules: {
                1: { title: "జన్మ తారా", summary: "మనస్సు/శరీర శ్రమ", guidance: "సాధార�్సు/శరీర శ్రమ", guidance: "సాధారణంగా శుభకార్యాలకు నివారించుట మంచిది" },
                2: { title: "సంపత్ తారా", summary: "లాభం/ధనం/వృద్ధి", guidance: "ధన, వ్యాపార, ప్రారంభ కార్యాలకు మంచిది" },
                3: { title: "విపత్ తారా", summary: "అడ్డంకులు/న�ిపత్ తారా", summary: "అడ్డంకులు/నష్టం", guidance: "ప్రయాణం మరియు ముఖ్య కార్యాలలో జాగ్రత్త" },
                ...
                6: { title: "సాధన తారా", summary: "సాధన/వి�" },
                6: { title: "సాధన తారా", summary: "సాధన/విజయం", guidance: "విద్య, మంత్రజపం, సాధన, ప్రయత్నాలకు మంచిది" },
                7: { title: "నైధన తారా", summary: "హాని/సంకట సూ�నైధన తారా", summary: "హాని/సంకట సూచన", guidance: "అత్యంత జాగ్రత్త; సాధ్యమైతే ముఖ్య కార్యాలు నివారించాలి" },
                8: { title: "మిత్ర తారా", summary: "సహకారం/స్నేహం", guidance: "సంభాష�ారం/స్నేహం", guidance: "సంభాషణ, సమావేశం, సంబంధాలకు మంచిది" },
        ...
        kn: {
            appTitle: "ತಾರಾಬಲಂ ಲೆಕ್ಕಾಚಾರದ ಕೋಷ್� ಲೆಕ್ಕಾಚಾರದ ಕೋಷ್ಟಕ ಮತ್ತು ಮ್ಯಾಟ್ರಿಕ್ಸ್",
            milestoneTag: "✨ ತಾರಾಬಲಂ ಎಂಬುದು ವ�Tag: "✨ ತಾರಾಬಲಂ ಎಂಬುದು ವೈದಿಕ ಜ್ಯೋತಿಷ್ಯದಲ್ಲಿ \"ನಕ್ಷತ್ರ ಬಲ\"ವನ್ನು ಸೂಚಿಸುತ್ತದೆ, ಇದು ವ್ಯಕ್ತಿಯ ಜನ್ಮ ನಕ್ಷತ್ರ ಮತ್ತು ಪ್ರಸ್ತುತ ದಿನದ ನಕ್ಷತ್ರದ ನಡುವಿನ ಹೊಂದಾಣಿಕೆಯನ್ನು ಲೆಕ್ಕಹಾಕಿ ಹೊಸ ಕೆಲಸಗಳ ಆರಂಭಕ್ಕೆ ಶುಭ ಮು��ೂರ್ತವನ್ನು ಆಯ್ಕೆ ಮಾಡಲು ಸಹಾ� ಕೆಲಸಗಳ ಆರಂಭಕ್ಕೆ ಶುಭ ಮುಹೂರ್ತವನ್ನು ಆಯ್ಕೆ ಮಾಡಲು ಸಹಾಯ ಮಾಡುತ್ತದೆ ✨",
            engineTitle: "ತಾರಾಬಲಂ ಗಣನೆ ಪ್ರಕ್ರಿಯೆ",
            matrixTitle: "ಸಂಪೂರ್ಣ ತಾರಾಬಲಂ 27x27 ಮಾಸ್ಟರ್ ಗ್ರಿಡ್ ನಕ್ಷೆ",
            sliderTitle: "ವೈದಿಕ � ಗ್ರಿಡ್ ನಕ್ಷೆ",
            ...
            outSummary: "ಫಲಿತಾಂ�ಲಿತಾಂಶ:",
            outSummary: "ಫಲಿತಾಂಶದ ಸಾರಾಂಶ:",
            outGuidance: "ಪ್ರಾಯೋಗಿಕ ಸೂಚನೆಗಳು:",
            footerLabel: "ಹೆಚ್ಚಿನ ವಿವರಗಳಿಗಾಗಿ ನಮ್�ೂಚನೆಗಳು:",
            ...
            rules: {
                1: { title: "��ನ್ಮ ತಾರಾ", summary: "ಮಾನಸಿಕ ಮತ್ತು ದೈ��ಿಕ ಶ್ರಮ", guidance: "ಸಾಮಾನ್ಯವಾಗಿ ಶು�ತ್ತರಾಭಾದ್ರಪದ", "ರೇವತಿ"],
            rules: {
                1: { title: "ಜನ್ಮ ತಾರಾ", summary: "ಮಾನಸಿಕ ಮತ್ತು ದೈಹಿಕ ಶ್ರಮ", guidance: "ಸಾಮಾನ್ಯವಾಗಿ ಶುಭ ಕಾರ್ಯಗಳಿಗೆ ಇದನ್ನು ವರ್ಜಿಸುವುದು ಉತ್ತಮ" },
                2: { title: "ಸಂಪತ್ �ುದು ಉತ್ತಮ" },
                2: { title: "ಸಂಪತ್ ತಾರಾ", summary: "ಲಾಭ, ಧನ ಧಾನ್ಯ ಮತ್ತು ವೃದ್ಧಿ", guidance: "ಹಣಕಾಸು, ವ್ಯಾಪಾರ ಹಾಗೂ ಹೊಸ ಉದ್ಯೋಗ ಆರಂಭಕ್ಕೆ ಉತ್ತಮ" },
                3: { title: "ವಿಪತ್ ತಾರಾ", summary: "ಅಡೆತಡೆಗಳು ಮತ್ತು ನ�್ ತಾರಾ", summary: "ಅಡೆತಡೆಗಳು ಮತ್ತು ನಷ್ಟದ ಭೀತಿ", guidance: "ಪ್ರಯಾಣ ಮತ್ತು ಪ್ರಮುಖ ಕಾರ್ಯಗಳನ್ನು ಮಾಡುವಾಗ ��ಾಗರೂಕರಾಗಿರಿ" },
                4: { title: "ಕ್ಷೇಮ ತಾರಾ", summary: "��ಾಂತಿ, ರಕ್ಷಣೆ ಮತ್ತು ಸೌ�ತ್ತು ಪ್ರಮುಖ ಕಾರ್ಯಗಳನ್ನು ಮಾಡುವಾಗ ಜಾಗರೂಕರಾಗಿರಿ" },
                ...
                6: { title: "ಸಾಧನಾ ತಾರಾ", summary: "ಸಾಧನೆ ಮತ್ತು ನಿರೀಕ್ಷಿತ ಯಶಸ್ಸು", guidance: "ವಿದ್ಯಾಭ್ಯಾಸ, ಮಂತ್ರ ಜಪ ಮತ್ತು �ಿದ್ಯಾಭ್ಯಾಸ, ಮಂತ್ರ ಜಪ ಮತ್ತು ತಾಂತ್ರಿಕ ಪ್ರಯತ್ನಗಳಿಗೆ ಸೂಕ್ತ" },
                7: { title: "ನೈಧನ ತಾರಾ", summary: "ಹಾನಿ ಮತ್ತು ಸಂಕಟದ ಮುನ್ಸೂಚನೆ", guidance: "ಅತ್ಯಂತ ಜಾಗರೂಕರಾಗಿರಿ; ಸಾಧ್ಯವಾದರೆ ಶುಭ ಕಾರ್ಯಗಳನ್ನು ಮುಂದೂಡಿ" },
                8: { title: "ಮಿತ್ರ ��ಾರಾ", summary: "ಸಹಕಾರ ಮತ್ತು ಸೌಹಾರ್ದತೆ", guidance: "ಸಂವ��ನ, ಸಭೆಗಳು ಮತ್ತು ಹೊಸ ಸಂ�್ಯವಾದರೆ ಶುಭ ಕಾರ್ಯಗಳನ್ನು ಮುಂದೂಡಿ" },
                8: { title: "ಮಿತ್ರ ತಾರಾ", summary: "ಸಹಕಾರ ಮತ್ತು ಸೌಹಾರ್ದತೆ", guidance: "ಸಂವಹನ, ಸಭೆಗಳು ಮತ್ತು ಹೊಸ ಸಂಬಂಧಗಳನ್ನು ಬೆಳೆಸಲು ಒಳ್ಳೆಯದು" },
                9: { title: "ಪರಮ ಮಿತ್ರ ತಾರಾ", summary: "ಉತ್ತಮ ಸಹಕಾರ ಮತ್ತು ಪರಿಪೂರ್ಣ ಫಲ", guidance: "ಎಲ್ಲಾ ��ೀತಿಯ ಸತ್ಕಾರ್ಯಗಳ ಆರಂಭಕ್ಕೆ ಅತ್ಯಂತ ಶ್ರೇಷ್ಠವಾ�ಾರ ಮತ್ತು ಪರಿಪೂರ್ಣ ಫಲ", guidance: "ಎಲ್ಲಾ ರೀತಿಯ ಸತ್ಕಾರ್ಯಗಳ ಆರಂಭಕ್ಕೆ ಅತ್ಯಂತ ಶ್ರೇಷ್ಠವಾದದ್ದು" }
            }
        }
    };
